...
const translations = {
  ar: {
    ...
    // AIZONIQ Academy
    'academy.badge': 'أكاديمية AIZONIQ',
    'academy.title': 'أتقن الذكاء الاصطناعي في',
    'academy.subtitle': 'تعلم بناء المواقع والشات بوت وأتمتة عملك بالكامل باستخدام قوة الذكاء الاصطناعي. لا تحتاج خبرة برمجية.',
    'academy.stat.students': 'طالب مسجل',
    'academy.stat.rating': '⭐ تقييم الدورة',
    'academy.stat.guarantee': 'ضمان استرداد الأموال',
    'academy.cta': 'ابدأ التعلم الآن',
    
    'academy.curriculum.badge': 'المنهج الكامل',
    'academy.curriculum.title': 'كل ما ستتعلمه',
    'academy.curriculum.desc': 'من مبتدئ تماماً إلى خبير في الذكاء الاصطناعي خلال أسابيع',
    
    'curriculum.web.title': 'بناء المواقع بالذكاء الاصطناعي',
    'curriculum.web.desc': 'ابنِ مواقع احترافية مذهلة في ساعات بدون أي معرفة برمجية باستخدام أدوات الذكاء الاصطناعي',
    'curriculum.web.f1': 'صفحات الهبوط ومواقع الأعمال',
    'curriculum.web.f2': 'متاجر إلكترونية',
    'curriculum.web.f3': 'مواقع المحفظة',
    
    'curriculum.chatbot.title': 'إنشاء الشات بوت الذكي',
    'curriculum.chatbot.desc': 'أنشئ شات بوت ذكي يتعامل مع خدمة العملاء والمبيعات والدعم 24/7',
    'curriculum.chatbot.f1': 'بوتات خدمة العملاء',
    'curriculum.chatbot.f2': 'المبيعات وتوليد العملاء',
    'curriculum.chatbot.f3': 'التكامل متعدد المنصات',
    
    'curriculum.automation.title': 'أتمتة سير العمل',
    'curriculum.automation.desc': 'أتمت المهام المتكررة ووفر أكثر من 20 ساعة أسبوعياً مع الأتمتة الذكية',
    'curriculum.automation.f1': 'أتمتة البريد والتسويق',
    'curriculum.automation.f2': 'معالجة البيانات',
    'curriculum.automation.f3': 'سير عمل الأعمال',
    
    'curriculum.content.title': 'إنشاء المحتوى بالذكاء الاصطناعي',
    'curriculum.content.desc': 'أنتج محتوى عالي الجودة للمدونات والسوشيال ميديا والتسويق في دقائق',
    'curriculum.content.f1': 'المقالات والمدونات',
    'curriculum.content.f2': 'محتوى السوشيال ميديا',
    'curriculum.content.f3': 'نصوص التسويق',
    
    'curriculum.images.title': 'توليد الصور بالذكاء الاصطناعي',
    'curriculum.images.desc': 'أنشئ صور مذهلة وشعارات وجرافيكس باستخدام أدوات توليد الصور بالذكاء الاصطناعي',
    'curriculum.images.f1': 'صور المنتجات',
    'curriculum.images.f2': 'أصول العلامة التجارية والشعارات',
    'curriculum.images.f3': 'جرافيكس السوشيال ميديا',
    
    'curriculum.business.title': 'الذكاء الاصطناعي للأعمال',
    'curriculum.business.desc': 'طبق الذكاء الاصطناعي لزيادة الإيرادات وتحسين العمليات والتفوق على المنافسين',
    'curriculum.business.f1': 'استراتيجية الأعمال مع AI',
    'curriculum.business.f2': 'تحليلات العملاء',
    'curriculum.business.f3': 'الميزة التنافسية',
    
    'card.popular': 'الأكثر طلباً',
    
    'instructor.label': 'مدربك',
    'instructor.name': 'فريق خبراء AIZONIQ',
    'instructor.bio': 'فريقنا من متخصصي الذكاء الاصطناعي درب آلاف المحترفين حول العالم. مع سنوات من الخبرة في تنفيذ حلول الذكاء الاصطناعي لشركات Fortune 500، قمنا بتلخيص معرفتنا في هذا البرنامج الشامل.',
    'instructor.certified': 'خبير AI معتمد',
    'instructor.years': 'سنوات خبرة',
    'instructor.trained': 'طالب تم تدريبه',
    'instructor.companies': 'شركة تم خدمتها',
    
    'pricing.badge': 'اختر مسارك',
    'pricing.title': 'استثمر في مستقبلك',
    'pricing.subtitle': 'اختر الخطة التي تناسب أهدافك. جميع الخطط تشمل وصول مدى الحياة.',
    
    'plan.starter': 'المبتدئ',
    'plan.professional': 'الاحترافي',
    'plan.master': 'الماستر',
    'plan.oneTime': 'دفعة واحدة',
    'plan.bestValue': 'أفضل قيمة',
    'plan.save': 'وفر $200',
    
    'starter.f1': '10 ساعات فيديو HD',
    'starter.f2': 'دورة أساسيات AI',
    'starter.f3': 'تدريب شات بوت أساسي',
    'starter.f4': 'موارد قابلة للتحميل',
    'starter.f5': 'دعم بالبريد',
    'starter.f6': 'شهادة إتمام',
    'starter.f7': 'الوحدات المتقدمة',
    'starter.f8': 'إرشاد فردي',
    
    'pro.f1': '+40 ساعة فيديو HD',
    'pro.f2': 'برنامج إتقان AI الكامل',
    'pro.f3': 'بناء المواقع بالذكاء الاصطناعي',
    'pro.f4': 'تطوير شات بوت متقدم',
    'pro.f5': 'أنظمة أتمتة كاملة',
    'pro.f6': 'تطبيقات الأعمال بـ AI',
    'pro.f7': 'جلسة إرشاد مباشرة',
    'pro.f8': 'دعم ذو أولوية',
    'pro.f9': 'شهادة احترافية',
    
    'master.f1': '+80 ساعة فيديو HD',
    'master.f2': 'كل محتوى الاحترافي',
    'master.f3': 'ابنِ أدواتك الخاصة بـ AI',
    'master.f4': 'تدريب حلول المؤسسات',
    'master.f5': '5 جلسات إرشاد مباشرة',
    'master.f6': 'دخول المجتمع الخاص',
    'master.f7': 'تحديثات مدى الحياة',
    'master.f8': 'قناة دعم VIP',
    'master.f9': 'شهادة ماستر',
    
    'btn.getStarted': 'ابدأ الآن',
    'btn.goMaster': 'انطلق للماستر',
    
    'payment.title': 'طرق دفع آمنة وموثوقة',
    'payment.saudi': 'معتمد في السعودية',
    'payment.mada': 'مدى',
    'payment.tamara': 'تمارا',
    'payment.tabby': 'تابي',
    'payment.popular': 'الأكثر استخداماً',
    'payment.installment': 'تقسيط',
    'currency.sar': 'ر.س',
    'trust.ssl': 'تشفير SSL 256-bit',
    'trust.refund': 'ضمان استرداد 30 يوم',
    'trust.lifetime': 'وصول مدى الحياة',
    'trust.saudi': 'معتمد من مؤسسة النقد',
    'plan.save': 'وفر 750 ريال',
    
    'testimonials.badge': 'قصص نجاح',
    'testimonials.title': 'ماذا يقول طلابنا',
    
    'testimonial.1.text': 'هذه الدورة غيرت طريقة عملي تماماً. بنيت موقع شركتي بالكامل في يومين فقط باستخدام ما تعلمته. قيمة لا تصدق!',
    'testimonial.1.name': 'سارة جونسون',
    'testimonial.1.role': 'مؤسسة شركة ناشئة',
    
    'testimonial.2.text': 'أتمتُ 80% من دعم العملاء باستخدام مهارات الشات بوت التي تعلمتها. فريقي الآن يركز على المهام عالية القيمة. أفضل استثمار!',
    'testimonial.2.name': 'محمد الراشد',
    'testimonial.2.role': 'صاحب متجر إلكتروني',
    
    'testimonial.3.text': 'كشخص بدون خلفية تقنية، اندهشت من سهولة المتابعة. الآن أعمل كفريلانسر وأجني $5K شهرياً ببناء حلول AI!',
    'testimonial.3.name': 'أليكس تشين',
    'testimonial.3.role': 'فريلانسر',
    
    'faq.badge': 'أسئلة؟',
    'faq.title': 'الأسئلة الشائعة',
    
    'academy.faq.q1': 'هل أحتاج أي خلفية تقنية؟',
    'academy.faq.a1': 'أبداً! هذه الدورة مصممة للمبتدئين تماماً. نبدأ من الأساسيات ونرشدك خطوة بخطوة. إذا كنت تستطيع استخدام الكمبيوتر وتصفح الإنترنت، يمكنك إتقان AI.',
    
    'academy.faq.q2': 'كم مدة الوصول؟',
    'academy.faq.a2': 'تحصل على وصول مدى الحياة! بمجرد التسجيل، يمكنك الوصول لجميع مواد الدورة للأبد، بما في ذلك جميع التحديثات المستقبلية.',
    
    'academy.faq.q3': 'ماذا لو لم أكن راضياً؟',
    'academy.faq.a3': 'نقدم ضمان استرداد الأموال لمدة 30 يوم. إذا لم تكن راضياً تماماً عن الدورة، راسلنا خلال 30 يوم لاسترداد كامل. بدون أسئلة.',
    
    'academy.faq.q4': 'هل الشهادة معتمدة؟',
    'academy.faq.a4': 'نعم! شهادتنا معتمدة من قبل أصحاب العمل ويمكن إضافتها لملفك على LinkedIn. كثير من خريجينا استخدموها للحصول على وظائف وعملاء.',
    
    'cta.title': 'هل أنت مستعد لتحويل مستقبلك؟',
    'cta.subtitle': 'انضم لآلاف الطلاب الذين يتقنون AI بالفعل. ابدأ اليوم وشاهد النتائج خلال أسبوعك الأول.',
    'cta.button': 'ابدأ رحلتك مع AI الآن',
    'cta.guarantee': 'ضمان استرداد 30 يوم • دفع آمن • وصول فوري',
  ...
  en: {
    ...
    // AIZONIQ Academy
    'academy.badge': 'AIZONIQ ACADEMY',
    'academy.title': 'Master AI in',
    'academy.subtitle': 'Learn to build websites, chatbots, and automate your entire business using the power of artificial intelligence. No coding required.',
    'academy.stat.students': 'Students Enrolled',
    'academy.stat.rating': '⭐ Course Rating',
    'academy.stat.guarantee': 'Money-Back Guarantee',
    'academy.cta': 'Start Learning Now',
    
    'academy.curriculum.badge': 'Complete Curriculum',
    'academy.curriculum.title': 'Everything You\'ll Master',
    'academy.curriculum.desc': 'From complete beginner to AI power user in just weeks',
    
    'curriculum.web.title': 'AI Website Building',
    'curriculum.web.desc': 'Build stunning, professional websites in hours without any coding knowledge using AI-powered tools',
    'curriculum.web.f1': 'Landing Pages & Business Sites',
    'curriculum.web.f2': 'E-commerce Stores',
    'curriculum.web.f3': 'Portfolio Websites',
    
    'curriculum.chatbot.title': 'Smart Chatbot Creation',
    'curriculum.chatbot.desc': 'Create intelligent chatbots that handle customer service, sales, and support 24/7',
    'curriculum.chatbot.f1': 'Customer Service Bots',
    'curriculum.chatbot.f2': 'Sales & Lead Generation',
    'curriculum.chatbot.f3': 'Multi-Platform Integration',
    
    'curriculum.automation.title': 'Workflow Automation',
    'curriculum.automation.desc': 'Automate repetitive tasks and save 20+ hours every week with intelligent automation',
    'curriculum.automation.f1': 'Email & Marketing Automation',
    'curriculum.automation.f2': 'Data Processing',
    'curriculum.automation.f3': 'Business Workflows',
    
    'curriculum.content.title': 'AI Content Creation',
    'curriculum.content.desc': 'Generate high-quality content for blogs, social media, and marketing in minutes',
    'curriculum.content.f1': 'Blog Posts & Articles',
    'curriculum.content.f2': 'Social Media Content',
    'curriculum.content.f3': 'Marketing Copy',
    
    'curriculum.images.title': 'AI Image Generation',
    'curriculum.images.desc': 'Create stunning visuals, logos, and graphics using AI art generation tools',
    'curriculum.images.f1': 'Product Images',
    'curriculum.images.f2': 'Brand Assets & Logos',
    'curriculum.images.f3': 'Social Media Graphics',
    
    'curriculum.business.title': 'AI for Business',
    'curriculum.business.desc': 'Apply AI to grow revenue, optimize operations, and outperform competitors',
    'curriculum.business.f1': 'Business Strategy with AI',
    'curriculum.business.f2': 'Customer Analytics',
    'curriculum.business.f3': 'Competitive Advantage',
    
    'card.popular': 'Most Requested',
    
    'instructor.label': 'Your Instructor',
    'instructor.name': 'AIZONIQ Expert Team',
    'instructor.bio': 'Our team of AI specialists has trained thousands of professionals worldwide. With years of experience implementing AI solutions for Fortune 500 companies, we\'ve distilled our knowledge into this comprehensive program.',
    'instructor.certified': 'Certified AI Expert',
    'instructor.years': 'Years Experience',
    'instructor.trained': 'Students Trained',
    'instructor.companies': 'Companies Served',
    
    'pricing.badge': 'Choose Your Path',
    'pricing.title': 'Invest in Your Future',
    'pricing.subtitle': 'Select the plan that matches your goals. All plans include lifetime access.',
    
    'plan.starter': 'Starter',
    'plan.professional': 'Professional',
    'plan.master': 'Master',
    'plan.oneTime': 'One-time payment',
    'plan.bestValue': 'BEST VALUE',
    'plan.save': 'Save $200',
    
    'starter.f1': '10 Hours of HD Video',
    'starter.f2': 'AI Fundamentals Course',
    'starter.f3': 'Basic Chatbot Training',
    'starter.f4': 'Downloadable Resources',
    'starter.f5': 'Email Support',
    'starter.f6': 'Certificate of Completion',
    'starter.f7': 'Advanced Modules',
    'starter.f8': '1-on-1 Mentoring',
    
    'pro.f1': '40+ Hours of HD Video',
    'pro.f2': 'Complete AI Mastery Program',
    'pro.f3': 'Website Building with AI',
    'pro.f4': 'Advanced Chatbot Development',
    'pro.f5': 'Full Automation Systems',
    'pro.f6': 'AI Business Applications',
    'pro.f7': '1 Live Mentoring Session',
    'pro.f8': 'Priority Support',
    'pro.f9': 'Professional Certificate',
    
    'master.f1': '80+ Hours of HD Video',
    'master.f2': 'Everything in Professional',
    'master.f3': 'Build Your Own AI Tools',
    'master.f4': 'Enterprise Solutions Training',
    'master.f5': '5 Live Mentoring Sessions',
    'master.f6': 'Private Community Access',
    'master.f7': 'Lifetime Updates',
    'master.f8': 'VIP Support Channel',
    'master.f9': 'Master Certificate',
    
    'btn.getStarted': 'Get Started',
    'btn.goMaster': 'Go Master',
    
    'payment.title': 'Secure & Trusted Payment Methods',
    'payment.saudi': 'Saudi Approved',
    'payment.mada': 'Mada',
    ...
    'trust.refund': '30-Day Money Back',
    'trust.lifetime': 'Lifetime Access',
    'trust.saudi': 'SAMA Approved',
    'plan.save': 'Save 750 SAR',
    
    'testimonials.badge': 'Success Stories',
    'testimonials.title': 'What Our Students Say',
    
    'testimonial.1.text': '"This course completely transformed how I work. I built my company\'s entire website in just 2 days using what I learned. Absolutely incredible value!"',
    'testimonial.1.name': 'Sarah Johnson',
    'testimonial.1.role': 'Startup Founder',
    
    'testimonial.2.text': '"I automated 80% of my customer support using the chatbot skills I learned. My team now focuses on high-value tasks. Best investment ever!"',
    'testimonial.2.name': 'Mohammed Al-Rashid',
    'testimonial.2.role': 'E-commerce Owner',
    
    'testimonial.3.text': '"As someone with zero tech background, I was amazed at how easy it was to follow. Now I\'m freelancing and making $5K/month building AI solutions!"',
    'testimonial.3.name': 'Alex Chen',
    'testimonial.3.role': 'Freelancer',
    
    'faq.badge': 'Questions?',
    
    'academy.faq.q1': 'Do I need any technical background?',
    'academy.faq.a1': 'Not at all! This course is designed for complete beginners. We start from the basics and guide you step-by-step. If you can use a computer and browse the internet, you can master AI.',
    
    'academy.faq.q2': 'How long do I have access?',
    'academy.faq.a2': 'You get lifetime access! Once you enroll, you can access all course materials forever, including all future updates we add to the curriculum.',
    
    'academy.faq.q3': 'What if I\'m not satisfied?',
    'academy.faq.a3': 'We offer a 30-day money-back guarantee. If you\'re not completely satisfied with the course, just email us within 30 days for a full refund. No questions asked.',
    
    'academy.faq.q4': 'Is the certificate recognized?',
    'academy.faq.a4': 'Yes! Our certificate is recognized by employers and can be added to your LinkedIn profile. Many of our graduates have used it to land jobs and freelance clients.',
    
    'cta.title': 'Ready to Transform Your Future?',
    'cta.subtitle': 'Join thousands of students already mastering AI. Start today and see results within your first week.',
    'cta.button': 'Start Your AI Journey Now',
    'cta.guarantee': '30-Day Money-Back Guarantee • Secure Payment • Instant Access',
